...
@:structInit class SaveVariables {
	...
	public var skipGameJoltScreen:Bool = false;
	...
	public var strumAlpha:Float = 0.8;
	...
	public var ghostTapping:Bool = false; // i hate ghost tapping
