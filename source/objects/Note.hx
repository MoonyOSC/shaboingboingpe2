...
class Note extends FlxSprite
{
	...
	public var ignoreAnimation:Bool = false;
	...
	**/
	...
	function loadNoteAnims() {
		...
		if (isSustainNote)
		{
			...
			animation.addByPrefix(colArray[noteData] + 'holdend', colArray[noteData] + ' hold end0', 24, true);
			animation.addByPrefix(colArray[noteData] + 'hold', colArray[noteData] + ' hold piece0', 24, true);
			animation.addByPrefix(colArray[noteData] + 'holdendconf', colArray[noteData] + ' hold end confirm', 24, true);	
			animation.addByPrefix(colArray[noteData] + 'holdconf', colArray[noteData] + ' hold piece confirm', 24, true);	
		}
